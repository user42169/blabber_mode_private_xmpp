...
public class MediaAdapter extends RecyclerView.Adapter<MediaAdapter.MediaViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MediaViewHolder holder, int position) {
        ...
        holder.binding.getRoot().setOnLongClickListener(v -> {
            ...
            popupMenu.getMenu().findItem(R.id.action_delete)
                    .setVisible(isDeletableFile(new File(attachment.getUri().getPath())));
    ...
    private void share(final Attachment attachment) {
        ...
        try {
            ...
            // available
            ToastCompat.makeText(this.activity, R.string.no_application_found_to_open_file, ToastCompat.LENGTH_SHORT)
                    .show();
        }
    }
    ...
    private void open(final Attachment attachment) {
        ...
        try {
            ...
            ToastCompat.makeText(this.activity,
                    this.activity.getString(R.string.no_permission_to_access_x, file.getAbsolutePath()),
    ...
    private boolean isDeletableFile(File file) {
        return (file == null || !file.toString().startsWith("/")
                || file.toString().contains(getConversationsDirectory(this.activity, "null").getAbsolutePath()));
    }
    ...
    private void loadPreview(Attachment attachment, ImageView imageView) {
        if (cancelPotentialWork(attachment, imageView)) {
            final Bitmap bm = activity.xmppConnectionService.getFileBackend().getPreviewForUri(attachment, mediaSize,
                    true);
            if (bm != null) {
